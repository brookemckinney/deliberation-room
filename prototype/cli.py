...
def run_composition_handoff(
    state: DeliberationState,
) -> None:
    """Run the current prototype's composition phase."""
    ...
    while True:
        ...
        if choice in artifact_options:
            artifact_type = artifact_options[choice]
            break
